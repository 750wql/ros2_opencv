...
public:
  PhigrosClicker() : Node("phigros_clicker") {  //创建节点“phigros_clicker"
...
private:
  ...
  void image_callback(const sensor_msgs::msg::Image::SharedPtr msg)
  {
    ...
    try
    {
      ...
      cv::findContours(blue_mask, contours, cv::RETR_EXTERNAL, cv::CHAIN_APPROX_NONE);
      ...
      cv::HoughLinesP(edges, lines, 1.0, CV_PI/180.0, 100, 500, 10);
      ...
      if(lines_center_[0].y - blue_center_[0].y <= 20 )
      {
